...
export const useAIChat = (currentSessionId: string | null) => {
  ...
  const sendMessage = async (sessionId: string, userMessageId: string, assistantMessageId: string, setFeedbackMessageId: (id: string | null) => void, filters?: SearchFilters) => {
    setIsStreaming(true);
