...
export const SlideCard: React.FC<SlideCardProps> = ({
  ...
  return (
    <div
      ...
      className="group bg-white border border-gray-200 rounded-lg overflow-hidden hover:border-blue-500 hover:shadow-md transition-all cursor-pointer flex flex-col"
    >
